...
public final class Timestamps {
    ...
    public static final Timestamp MIN_VALUE =
            Timestamp.newBuilder().setSeconds(TIMESTAMP_SECONDS_MIN).setNanoseconds(0).build();

    /**
     * A constant holding the maximum valid {@link Timestamp}, {@code 9999-12-31T23:59:59.999999999Z}.
     */
    public static final Timestamp MAX_VALUE =
            Timestamp.newBuilder().setSeconds(TIMESTAMP_SECONDS_MAX).setNanoseconds(999999999).build();

    /**
     * A constant holding the {@link Timestamp} of epoch time, {@code 1970-01-01T00:00:00.000000000Z}.
     */
    public static final Timestamp EPOCH = Timestamp.newBuilder().setSeconds(0).setNanoseconds(0).build();
    ...
    private static SimpleDateFormat createTimestampFormat() {
        ...
        // We use Epileptic Gregorian Calendar (i.e., Gregorian calendar extends
    ...
    private static enum TimestampComparator implements Comparator<Timestamp>, Serializable {
        ...
        public int compare(Timestamp t1, Timestamp t2) {
            ...
            return (secDiff != 0) ? secDiff : Integer.compare(t1.getNanoseconds(), t2.getNanoseconds());
        }
    }
    ...
    public static boolean isValid(Timestamp timestamp) {
        return isValid(timestamp.getSeconds(), timestamp.getNanoseconds());
    }
     ...
     * long as they fit into nanoseconds precision.
     *
    ...
    public static Timestamp now() {
        if (INSTANT_NOW != null) {
            try {
                java.lang.Object now = INSTANT_NOW.invoke(null);
     ...
     * full nanosecond precision is retained.
     *
    ...
    public static Timestamp fromDate(Date date) {
        if (date instanceof java.sql.Timestamp) {
            ...
            return Timestamp.newBuilder()
                    ...
                    .setNanoseconds(sqlTimestamp.getNanos())
                    .build();
        } else {
    ...
    public static long toMillis(Timestamp timestamp) {
        ...
        return checkedAdd(
                ...
                timestamp.getNanoseconds() / NANOS_PER_MILLISECOND);
    }
    ...
    public static long toMicros(Timestamp timestamp) {
        ...
        return checkedAdd(
                ...
                timestamp.getNanoseconds() / NANOS_PER_MICROSECOND);
    }
    ...
    public static long toNanos(Timestamp timestamp) {
        checkValid(timestamp);
        return checkedAdd(
                checkedMultiply(timestamp.getSeconds(), NANOS_PER_SECOND), timestamp.getNanoseconds());
    }
    ...
    public static Duration between(Timestamp from, Timestamp to) {
        ...
        return Durations.normalizedDuration(
                ...
                checkedSubtract(to.getNanoseconds(), from.getNanoseconds()));
    }
    ...
    public static Timestamp add(Timestamp start, Duration length) {
        ...
        return normalizedTimestamp(
                ...
                checkedAdd(start.getNanoseconds(), length.getNanoseconds()));
    }
    ...
    public static Timestamp subtract(Timestamp start, Duration length) {
        ...
        return normalizedTimestamp(
                ...
                checkedSubtract(start.getNanoseconds(), length.getNanoseconds()));
    }
    ...
    static Timestamp normalizedTimestamp(long seconds, int nanos) {
        ...
        Timestamp timestamp = Timestamp.newBuilder().setSeconds(seconds).setNanoseconds(nanos).build();
