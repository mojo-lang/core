...
public class JsonFormat {
    ...
    public static class Printer {
        ...
        public <T extends MessageOrBuilder> String print(List<T> messages) throws InvalidProtocolBufferException {
            if (messages == null) {
                return "";
            }
            if (messages.isEmpty()) {
        ...
        public <T extends MessageOrBuilder> String print(Map<String, T> messages) throws InvalidProtocolBufferException {
            if (messages == null) {
                return "";
            }
            if (messages.isEmpty()) {
            ...
            try {
                ...
                for (Map.Entry<String, T> entry : messages.entrySet()) {
                    ...
                    appendTo(entry.getValue(), builder);
                    builder.append(",");
                }
    ...
    public static class Parser {
        ...
        public <T extends Message> List<T> listFromJSON(String json, Class<T> clazz) throws IOException {
            if (json == null) {
                return null;
            }
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                resultList.add(fromJSON(jsonArray.getString(i), clazz));
            }

            return resultList;
        }

        public <T extends Message> Map<String, T> mapFromJSON(String json, Class<T> clazz) throws IOException {
            if (json == null) {
                return null;
            }
            ...
            final Map<String, T> map = Maps.newHashMapWithExpectedSize(jsonObject.size());
            for (String key : jsonObject.keySet()) {
                final T v = fromJSON(jsonObject.getString(key), clazz);
                map.put(key, v);
            }
            return map;
        }
    ...
    private static final class PrinterImpl {
        ...
        private static Map<String, WellKnownTypePrinter> buildWellKnownTypePrinters() {
            ...
            printers.put(Float32Value.getDescriptor().getFullName(), wrappersPrinter);
            printers.put(Float64Value.getDescriptor().getFullName(), wrappersPrinter);
            ...
            // Special-case Struct.
            printers.put(
                    org.mojolang.mojo.core.Object.getDescriptor().getFullName(),
                    new WellKnownTypePrinter() {
                        @Override
                        public void print(PrinterImpl printer, MessageOrBuilder message) throws IOException {
            ...
            printers.put(
                    org.mojolang.mojo.core.Values.getDescriptor().getFullName(),
                    new WellKnownTypePrinter() {
                        @Override
                        public void print(PrinterImpl printer, MessageOrBuilder message) throws IOException {
            ...
            printers.put(
                    org.mojolang.mojo.core.Null.getDescriptor().getFullName(),
                    new WellKnownTypePrinter() {
                        @Override
                        public void print(PrinterImpl printer, MessageOrBuilder message) throws IOException {
                            printer.printNull(message);
                        }
                    });
            return printers;
        }
        ...
        private void printWrapper(MessageOrBuilder message) throws IOException {
            Descriptor descriptor = message.getDescriptorForType();
            FieldDescriptor valueField = descriptor.findFieldByName("val");
            if (valueField == null) {
        ...
        private void printFieldMask(MessageOrBuilder message) throws IOException {
            ...
            generator.print("\"" + FieldMasks.toJsonString(value) + "\"");
        }
        ...
        private void printStruct(MessageOrBuilder message) throws IOException {
            Descriptor descriptor = message.getDescriptorForType();
            FieldDescriptor field = descriptor.findFieldByName("vals");
            if (field == null) {
        ...
        private void printValue(MessageOrBuilder message) throws IOException {
            ...
            Map<FieldDescriptor, java.lang.Object> fields = message.getAllFields();
            if (fields.isEmpty()) {
                // No value set.
            ...
            for (Map.Entry<FieldDescriptor, java.lang.Object> entry : fields.entrySet()) {
        ...
        private void printNull(MessageOrBuilder message) throws IOException {
            generator.print("null");
        }
        ...
        private void print(MessageOrBuilder message, @Nullable String typeUrl) throws IOException {
            ...
            Map<FieldDescriptor, java.lang.Object> fieldsToPrint;
            if (shouldPrintDefaults == ShouldPrintDefaults.ONLY_IF_PRESENT) {
                fieldsToPrint = message.getAllFields();
            } else {
                fieldsToPrint = new TreeMap<FieldDescriptor, java.lang.Object>(message.getAllFields());
            ...
            for (Map.Entry<FieldDescriptor, java.lang.Object> field : fieldsToPrint.entrySet()) {
                if (printedField) {
        ...
        private void printField(FieldDescriptor field, java.lang.Object value) throws IOException {
        ...
        private void printRepeatedFieldValue(FieldDescriptor field, java.lang.Object value) throws IOException {
            generator.print("[");
            boolean printedElement = false;
            for (java.lang.Object element : (List) value) {
                if (printedElement) {
        ...
        private void printMapFieldValue(FieldDescriptor field, java.lang.Object value) throws IOException {
            ...
            Collection<java.lang.Object> elements = (List<java.lang.Object>) value;
            if (sortingMapKeys && !elements.isEmpty()) {
                Comparator<java.lang.Object> cmp = null;
                if (keyField.getType() == FieldDescriptor.Type.STRING) {
                    cmp = new Comparator<java.lang.Object>() {
                        @Override
                ...
                TreeMap<java.lang.Object, java.lang.Object> tm = new TreeMap<>(cmp);
                for (java.lang.Object element : elements) {
                    Message entry = (Message) element;
                    java.lang.Object entryKey = entry.getField(keyField);
            ...
            for (java.lang.Object element : elements) {
                Message entry = (Message) element;
                java.lang.Object entryKey = entry.getField(keyField);
                java.lang.Object entryValue = entry.getField(valueField);
                if (printedElement) {
                    generator.print("," + blankOrNewLine);
                } else {
                    printedElement = true;
        ...
        private void printSingleFieldValue(FieldDescriptor field, java.lang.Object value) throws IOException {
        ...
        private void printSingleFieldValue(
                final FieldDescriptor field, final java.lang.Object value, boolean alwaysWithQuotes)
                throws IOException {
            switch (field.getType()) {
                ...
                case UINT64:
                case FIXED64:
                    if (field.getFullName().equals("mojo.core.Value.positive_val")) {
                        if (alwaysWithQuotes) {
                            generator.print("\"");
                        }
                    ...
                    } else if (field.getFullName().equals("mojo.core.Value.negative_val")) {
                        if (alwaysWithQuotes) {
                            generator.print("\"");
                        }
                        generator.print(((Long) value).toString());
    ...
    private static class ParserImpl {
        ...
        private static Map<String, WellKnownTypeParser> buildWellKnownTypeParsers() {
            ...
            parsers.put(Float32Value.getDescriptor().getFullName(), wrappersPrinter);
            parsers.put(Float64Value.getDescriptor().getFullName(), wrappersPrinter);
            // Special-case Timestamp.
            parsers.put(
                    Timestamp.getDescriptor().getFullName(),
                    new WellKnownTypeParser() {
            ...
            // Special-case ListValue.
            parsers.put(
                    Values.getDescriptor().getFullName(),
                    new WellKnownTypeParser() {
                        @Override
                        public void merge(ParserImpl parser, JsonElement json, Message.Builder builder)
                                throws InvalidProtocolBufferException {
        ...
        private void mergeAny(JsonElement json, Message.Builder builder)
            ...
            FieldDescriptor typeUrlField = descriptor.findFieldByName("type");
            FieldDescriptor valueField = descriptor.findFieldByName("val");
            // Validates type of the message. Note that we can't just cast the message
            // to com.google.protobuf.Any because it might be a DynamicMessage.
            if (typeUrlField == null
        ...
        private void mergeFieldMask(JsonElement json, Message.Builder builder)
                throws InvalidProtocolBufferException {
            FieldMask value = FieldMasks.fromJsonString(json.getAsString());
        ...
        private void mergeValue(JsonElement json, Message.Builder builder)
            ...
            if (json instanceof JsonPrimitive) {
                ...
                if (primitive.isBoolean()) {
                    builder.setField(type.findFieldByName("bool_val"), primitive.getAsBoolean());
                } else if (primitive.isNumber()) {
                    double d = primitive.getAsDouble();
                    long l = primitive.getAsLong();
                    if (d > l) {
                        builder.setField(type.findFieldByName("double_val"), d);
                    } else {
                        if (l >= 0) {
                            builder.setField(type.findFieldByName("positive_val"), l);
                        } else {
                            builder.setField(type.findFieldByName("negative_val"), -l);
                        }
                    }
                } else {
                    builder.setField(type.findFieldByName("string_val"), primitive.getAsString());
                }
            } else if (json instanceof JsonObject) {
                FieldDescriptor field = type.findFieldByName("object_val");
                ...
                FieldDescriptor field = type.findFieldByName("values_val");
                ...
                builder.setField(
                        type.findFieldByName("null_val"), Nulls.instance());
            } else {
        ...
        private void mergeWrapper(JsonElement json, Message.Builder builder)
                throws InvalidProtocolBufferException {
            Descriptor type = builder.getDescriptorForType();
            FieldDescriptor field = type.findFieldByName("val");
            if (field == null) {
        ...
        private void mergeField(FieldDescriptor field, JsonElement json, Message.Builder builder)
            ...
            if (field.isMapField()) {
                ...
                java.lang.Object value = parseFieldValue(field, json, builder);
                if (value != null) {
        ...
        private void mergeMapField(FieldDescriptor field, JsonElement json, Message.Builder builder)
            ...
            for (Map.Entry<String, JsonElement> entry : object.entrySet()) {
                ...
                java.lang.Object key = parseFieldValue(keyField, new JsonPrimitive(entry.getKey()), entryBuilder);
                java.lang.Object value = parseFieldValue(valueField, entry.getValue(), entryBuilder);
                if (value == null) {
        ...
        private void mergeOneofField(FieldDescriptor field, JsonElement json, Message.Builder builder)
                throws InvalidProtocolBufferException {
            java.lang.Object value = parseFieldValue(field, json, builder);
            boolean isNullType = field.getType().name().equals("MESSAGE") && field.getMessageType().getFullName().equals("mojo.core.Null");
            if (value == null && !isNullType) {
                // A field interpreted as "null" is means it's treated as absent.
                return;
            }
            ...
            if (isNullType) {
                builder.setField(field, Nulls.instance());
            } else {
                builder.setField(field, value);
            }
        }
        ...
        private void mergeRepeatedField(
            ...
            for (int i = 0; i < array.size(); ++i) {
                java.lang.Object value = parseFieldValue(field, array.get(i), builder);
                if (value == null) {
        ...
        @Nullable
        private java.lang.Object parseFieldValue(FieldDescriptor field, JsonElement json, Message.Builder builder)
                throws InvalidProtocolBufferException {
            if (json instanceof JsonNull) {
                if (field.getJavaType() == FieldDescriptor.JavaType.MESSAGE
                    ...
                    Value value = Value.newBuilder().setNullVal(Nulls.instance()).build();
                    return builder.newBuilderForField(field).mergeFrom(value.toByteString()).build();
                } else if (field.getJavaType() == FieldDescriptor.JavaType.ENUM
                        && field.getEnumType().getFullName().equals(Null.getDescriptor().getFullName())) {
