...
type Value struct {
	...
	//	*Value_DoubleVal
	//	*Value_StringVal
	Value isValue_Value `protobuf_oneof:"value" json:"value,omitempty"`
}
...
func (x *Value) GetValuesVal() *Values {
	if x, ok := x.GetValue().(*Value_ValuesVal); ok {
		return x.ValuesVal
	}
	return nil
}
...
func (x *Value) GetObjectVal() *Object {
	if x, ok := x.GetValue().(*Value_ObjectVal); ok {
		return x.ObjectVal
	}
	return nil
}
...
func (x *Value) GetNullVal() *Null {
	if x, ok := x.GetValue().(*Value_NullVal); ok {
		return x.NullVal
	}
	return nil
}
...
func (x *Value) GetBoolVal() bool {
	if x, ok := x.GetValue().(*Value_BoolVal); ok {
		return x.BoolVal
	}
	return false
}
...
func (x *Value) GetInt64Val() int64 {
	if x, ok := x.GetValue().(*Value_Int64Val); ok {
		return x.Int64Val
	}
	return 0
}
...
func (x *Value) GetDoubleVal() float64 {
	if x, ok := x.GetValue().(*Value_DoubleVal); ok {
		return x.DoubleVal
	}
	return 0
}
...
func (x *Value) GetStringVal() string {
	if x, ok := x.GetValue().(*Value_StringVal); ok {
		return x.StringVal
	}
	return ""
}
...
var file_mojo_core_value_proto_rawDesc = []byte{
	...
	0xa4, 0x02, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x32, 0x0a, 0x0a, 0x76, 0x61, 0x6c,
	...
	,
...
var file_mojo_core_value_proto_goTypes = []interface{}{
	(*Object)(nil), // 0: mojo.core.Object
	(*Values)(nil), // 1: mojo.core.Values
	(*Value)(nil),  // 2: mojo.core.Value
	nil,            // 3: mojo.core.Object.ValsEntry
	(*Null)(nil),   // 4: mojo.core.Null
}
var file_mojo_core_value_proto_depIdxs = []int32{
	3, // 0: mojo.core.Object.vals:type_name -> mojo.core.Object.ValsEntry
	2, // 1: mojo.core.Values.vals:type_name -> mojo.core.Value
	1, // 2: mojo.core.Value.values_val:type_name -> mojo.core.Values
	0, // 3: mojo.core.Value.object_val:type_name -> mojo.core.Object
	4, // 4: mojo.core.Value.null_val:type_name -> mojo.core.Null
	2, // 5: mojo.core.Object.ValsEntry.value:type_name -> mojo.core.Value
