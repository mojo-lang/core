...
func (x *Value) Value() (driver.Value, error) {
	if x != nil {
...
func (x *Value) Scan(src interface{}) error {
	if x != nil && src != nil {
		switch v := src.(type) {
		case []byte:
...
func (x Value) GormDataType() string {
	return "string"
}

func (x *Value) GormDBDataType(db *gorm.DB, field *schema.Field) string {
