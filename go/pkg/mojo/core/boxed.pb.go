...
func (x *StringValues) Reset() {
	*x = StringValues{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mojo_core_boxed_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StringValues) Descriptor() ([]byte, []int) {
	return file_mojo_core_boxed_proto_rawDescGZIP(), []int{26}
}
...
var file_mojo_core_boxed_proto_rawDesc = []byte{
	...
	0x04, 0x76, 0x61, 0x6c, 0x73, 0x22, 0x1d, 0x0a, 0x07, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x73,
	...
	0x28, 0x09, 0x52, 0x04, 0x76, 0x61, 0x6c, 0x73, 0x42, 0x57, 0x0a, 0x16, 0x6f, 0x72, 0x67, 0x2e,
	0x6d, 0x6f, 0x6a, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2e, 0x6d, 0x6f, 0x6a, 0x6f, 0x2e, 0x63, 0x6f,
	0x72, 0x65, 0x42, 0x0a, 0x42, 0x6f, 0x78, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var file_mojo_core_boxed_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_mojo_core_boxed_proto_goTypes = []interface{}{
	...
	(*Strings)(nil),       // 25: mojo.core.Strings
	(*StringValues)(nil),  // 26: mojo.core.StringValues
}
...
func file_mojo_core_boxed_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mojo_core_boxed_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
