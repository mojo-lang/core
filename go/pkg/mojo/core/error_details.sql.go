...
func (x ErrorDetails) Value() (driver.Value, error) {
    if x != nil {
...
func (x ErrorDetails) Scan(src interface{}) error {
    if x != nil && src != nil {
        switch v := src.(type) {
        case []byte:
...
func (x ErrorDetails) GormDataType() string {
    return "string"
}

func (x ErrorDetails) GormDBDataType(db *gorm.DB, field *schema.Field) string {
